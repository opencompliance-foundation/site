...
- the publication-safe multi-registry auditor search explorer and generated dataset under `docs/data/`,
...
- unpublished implementation notes,
- credentials,
- or claims that outrun what the public repos actually ship.
