...
encryption-at-rest, unique-infrastructure-identity, and segmentation slices
already promoted and the next ISO-first work now focused on the remaining
password, WAF, availability, and environment controls.
